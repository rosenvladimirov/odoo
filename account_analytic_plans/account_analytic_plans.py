...
class account_invoice_line(osv.osv):
    ...
    def product_id_change(self, cr, uid, ids, pricelist, product, uom_id, date_inv, qty=0, name='', type='out_invoice', partner_id=False, fposition_id=False, price_unit=False, currency_id=False, company_id=None, context=None):
        res_prod = super(account_invoice_line, self).product_id_change(cr, uid, ids, pricelist, product, uom_id, date_inv, qty=qty, name=name, type=type, partner_id=partner_id, fposition_id=fposition_id, price_unit=price_unit, currency_id=currency_id, company_id=company_id, context=context)
