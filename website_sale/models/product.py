...
class product_attribute(osv.Model):
    ...
    _columns = {
        'type': fields.selection([('radio', 'Radio'), ('select', 'Select'), ('color', 'Color'), ('image', 'Image'), ('hidden', 'Hidden')], string="Type"),
    }
    _defaults = {
        'type': lambda *a: 'radio',
    }
...
class product_attribute_value(osv.Model):
    ...
    _columns = {
        ...
        'image': fields.binary('Image', help='Image for atribute value 50x50px'),
    }
